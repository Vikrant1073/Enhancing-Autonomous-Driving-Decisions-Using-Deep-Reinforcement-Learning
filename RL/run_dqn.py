...
# Create the DQN model using function imported from the model script
...
eval_callback = EvalCallback(eval_env, best_model_save_path='./logs/dqn_best_model',
                             log_path='./logs/dqn_eval', eval_freq=500,
