### This file content is directly imported from the setup file of the AirSim library
### Helps to find the AirSim intsallation
### URL for the file: https://github.com/microsoft/AirSim/blob/main/PythonClient/reinforcement_learning/setup_path.py
